<template>
  <div>
    <el-button-group class="btn_group__wrapper">
      <el-button size="small" type="primary" @click="$refs.dialog.show()"
    ...
    <CreateApplication ref="dialog" />
  </div>
</template>
<script>
import TableManage from "@/mixins/TableManage";
import Pagination from "@/mixins/Pagination";
import CreateApplication from "@/dialogs/applist/CreateApplication";
...
export default {
  ...
  computed: {
    applist() {
      return this.$store.getters["applist/list"];
    },
  ...
  async created() {
    try {
      this.$store.commit("common/isLoading");
      ...
      this.$store.commit("common/isLoading", false);
    }
  },
