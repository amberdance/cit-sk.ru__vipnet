...
import HistoryDetails from "@/components/dialogs/application/HistoryDetails";
import DeleteDetails from "@/components/dialogs/application/DeleteDetails";
...
export default {
  ...
  computed: {
    logs() {
      return this.$store.getters["storage/index"]("logs");
    },

    applist() {
      return this.$store.getters["storage/index"]("items");
    },
